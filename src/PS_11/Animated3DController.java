...
import PS_10.MyBox;
import PS_10.MyCylinder;
import PS_10.MySphere;
        ...
        Timeline timelineAnimation = new Timeline(
                new KeyFrame(Duration.millis(1000), new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent actionEvent) {
                        ...
                        PS_10.MyCylinder cylinder = new MyCylinder(randWidth, randHeight);
                        ...
                        Sphere sphere = new PS_10.MySphere(randRadius);
                        ...
                        Box cube = new PS_10.MyBox(randDepth,randHeight, randWidth);
